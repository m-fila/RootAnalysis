...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
float ELIHistograms::getSampleLuminosity(const std::string& sampleName, float crossSection){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
float ELIHistograms::getSampleNormalisation(std::string sampleName){

        float crossSection = ELIAnalysis::getCrossSection(sampleName);
        float sampleLuminosity = getSampleLuminosity(sampleName, crossSection);
        return 1.0/sampleLuminosity;
}
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
ELIHistograms::ELIHistograms(TDirectory *myDir){
        AnalysisHistograms::init(myDir);
}
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
ELIHistograms::ELIHistograms(TDirectory *myDir, const std::vector<std::string> & flavours, std::string channel){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
ELIHistograms::~ELIHistograms(){
}
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F *ELIHistograms::get1D_EWK2JetsSum(const std::string& name){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F *ELIHistograms::get1D_TauMatchJetSum(const std::string& name, bool sumDecayModes, bool sumJetBins){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F *ELIHistograms::get1D_WJet_Histogram(const std::string& name){
        return get1D_VJetSum(name);
}
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F *ELIHistograms::get1D_DYJet_Histogram(const std::string& name){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F *ELIHistograms::get1D_VJetSum(const std::string& name){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F* ELIHistograms::get1D_SumPattern_Histogram(const std::string& name, const std::string & pattern,
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F* ELIHistograms::get1D_VV_Histogram(const std::string& name, std::string tauMatchSuffix){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F* ELIHistograms::get1D_ST_Histogram(const std::string& name){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F* ELIHistograms::get1D_TT_Histogram(const std::string& name, std::string tauMatchSuffix){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
std::string ELIHistograms::getTemplateName(const std::string& name){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void ELIHistograms::defineHistograms(){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void ELIHistograms::finalizeHistograms(const std::vector<const ELIAnalysis::eventCategory*> & aCategoryRejester){

        std::cout<<"ELIHistograms::finalizeHistograms() START"<<std::endl;
	...
	bool doPlot = false;
        for(unsigned int iSystEffect = (unsigned int)ELIAnalysis::NOMINAL;
            iSystEffect<=(unsigned int)ELIAnalysis::ZmumuDown; ++iSystEffect) {
                if(iSystEffect==(unsigned int)ELIAnalysis::DUMMY_SYS) continue;
                for(auto iCategory: mainCategoriesRejester) {
        ...
        outputStream<<"ELIHistograms compilation time: "<<__TIMESTAMP__<<std::endl;
        eventCountFile<<outputStream.str();
        eventCountFile.close();

        std::cout<<"ELIHistograms::finalizeHistograms() END"<<std::endl;

}
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void ELIHistograms::plotCPhistograms(unsigned int iCategory){
        ...
        plotnPCA("ggELI125"+hNameSuffix);
        plotnPCA("ATT"+hNameSuffix);
        plotnPCA("DYJets"+hNameSuffix);
        plotnPCA("WJets"+hNameSuffix);

        plotPhiDecayPlanes("Phi-nVectorsggELI125"+hNameSuffix);
        plotPhiDecayPlanes("Phi-nVectorsATT"+hNameSuffix);
        plotPhiDecayPlanes("Phi-nVectorsDYJets"+hNameSuffix);

        plotPhiDecayPlanes("Phi-nVecIPggELI125"+hNameSuffix);
        plotPhiDecayPlanes("Phi-nVecIPATT"+hNameSuffix);
        plotPhiDecayPlanes("Phi-nVecIPDYJets"+hNameSuffix);

        plotProfiles("hProfRecoVsMagGen","ggELI125"+hNameSuffix);
        plotProfiles("hProfPhiVsMag","ggELI125"+hNameSuffix);

        plotVerticesPulls("h1DVxPullXggELI125"+hNameSuffix);
        plotVerticesPulls("h1DVxPullYggELI125"+hNameSuffix);
        plotVerticesPulls("h1DVxPullZggELI125"+hNameSuffix);

        plotPhiDecayPlanes("Phi-nVecIP-yTauPosggELI125"+hNameSuffix);
        plotPhiDecayPlanes("Phi-nVecIP-yTauNegggELI125"+hNameSuffix);
}
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void ELIHistograms::plotnPCA(const std::string & type){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void ELIHistograms::plotVerticesPulls(const std::string & hName){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void ELIHistograms::plotProfiles(const std::string & hName,
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void ELIHistograms::plotPhiDecayPlanes(const std::string & name){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void ELIHistograms::plot_HAZ_Histograms(const std::string & hName,
                                        const std::string & sysType){
        ...
        TString name = "h1D"+hName+"ggELI125"+sysType;
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void ELIHistograms::plotSingleHistogram(std::string hName){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
THStack*  ELIHistograms::plotStack(unsigned int iCategory,
                                   std::string varName, unsigned int iSystEffect, bool doPlot){

        std::string hName = "h1D"+varName;
        std::string categoryName = myCategoryRejester[iCategory]->name();
        std::string systEffectName = ELIAnalysis::systEffectName(iCategory, iSystEffect, myCategoryRejester);
        std::string hNameSuffix = "_"+categoryName+systEffectName;
	
        TH1F *hggHiggs110 = get1DHistogram((hName+"ggELI110"+hNameSuffix));
        TH1F *hggHiggs120 = get1DHistogram((hName+"ggELI120"+hNameSuffix));
        TH1F *hggHiggs125 = get1DHistogram((hName+"ggELI125"+hNameSuffix));
        TH1F *hggHiggs130 = get1DHistogram((hName+"ggELI130"+hNameSuffix));
        TH1F *hggHiggs140 = get1DHistogram((hName+"ggELI140"+hNameSuffix));

        TH1F *hqqHiggs110 = get1DHistogram((hName+"qqELI110"+hNameSuffix));
        TH1F *hqqHiggs120 = get1DHistogram((hName+"qqELI120"+hNameSuffix));
        TH1F *hqqHiggs125 = get1DHistogram((hName+"qqELI125"+hNameSuffix));
        TH1F *hqqHiggs130 = get1DHistogram((hName+"qqELI130"+hNameSuffix));
        TH1F *hqqHiggs140 = get1DHistogram((hName+"qqELI140"+hNameSuffix));

        TH1F *hZHiggs110 = get1DHistogram((hName+"ZELI110"+hNameSuffix));
        TH1F *hZHiggs120 = get1DHistogram((hName+"ZELI120"+hNameSuffix));
        TH1F *hZHiggs125 = get1DHistogram((hName+"ZELI125"+hNameSuffix));
        TH1F *hZHiggs130 = get1DHistogram((hName+"ZELI130"+hNameSuffix));
        TH1F *hZHiggs140 = get1DHistogram((hName+"ZELI140"+hNameSuffix));

        TH1F *hWplusHiggs110 = get1DHistogram((hName+"WplusELI110"+hNameSuffix));
        TH1F *hWplusHiggs120 = get1DHistogram((hName+"WplusELI120"+hNameSuffix));
        TH1F *hWplusHiggs125 = get1DHistogram((hName+"WplusELI125"+hNameSuffix));
        TH1F *hWplusHiggs130 = get1DHistogram((hName+"WplusELI130"+hNameSuffix));
        TH1F *hWplusHiggs140 = get1DHistogram((hName+"WplusELI140"+hNameSuffix));

        TH1F *hWminusHiggs110 = get1DHistogram((hName+"WminusELI110"+hNameSuffix));
        TH1F *hWminusHiggs120 = get1DHistogram((hName+"WminusELI120"+hNameSuffix));
        TH1F *hWminusHiggs125 = get1DHistogram((hName+"WminusELI125"+hNameSuffix));
        TH1F *hWminusHiggs130 = get1DHistogram((hName+"WminusELI130"+hNameSuffix));
        TH1F *hWminusHiggs140 = get1DHistogram((hName+"WminusELI140"+hNameSuffix));

        TH1F *hWJets = get1D_WJet_Histogram((hName+"WJets"+hNameSuffix));
        TH1F *ELIbarJ = get1D_TT_Histogram((hName+"TTbar"+hNameSuffix),"MatchJ");
        TH1F *ELIbarT = get1D_TT_Histogram((hName+"TTbar"+hNameSuffix),"MatchT");
        ...
        if(!ELIbarJ) ELIbarJ = (TH1F*)hEmpty->Clone((hName+"TTbarMatchJ"+hNameSuffix).c_str());
        if(!ELIbarT) ELIbarT = (TH1F*)hEmpty->Clone((hName+"TTbarMatchT"+hNameSuffix).c_str());
        ...
        if(!hggHiggs110) hggHiggs110 = (TH1F*)hEmpty->Clone((hName+"ggELI110"+hNameSuffix).c_str());
        if(!hggHiggs120) hggHiggs120 = (TH1F*)hEmpty->Clone((hName+"ggELI120"+hNameSuffix).c_str());
        if(!hggHiggs125) hggHiggs125 = (TH1F*)hEmpty->Clone((hName+"ggELI125"+hNameSuffix).c_str());
        if(!hggHiggs130) hggHiggs130 = (TH1F*)hEmpty->Clone((hName+"ggELI130"+hNameSuffix).c_str());
        if(!hggHiggs140) hggHiggs140 = (TH1F*)hEmpty->Clone((hName+"ggELI140"+hNameSuffix).c_str());

        if(!hqqHiggs110) hqqHiggs110 = (TH1F*)hEmpty->Clone((hName+"qqELI110"+hNameSuffix).c_str());
        if(!hqqHiggs120) hqqHiggs120 = (TH1F*)hEmpty->Clone((hName+"qqELI120"+hNameSuffix).c_str());
        if(!hqqHiggs125) hqqHiggs125 = (TH1F*)hEmpty->Clone((hName+"qqELI125"+hNameSuffix).c_str());
        if(!hqqHiggs130) hqqHiggs130 = (TH1F*)hEmpty->Clone((hName+"qqELI130"+hNameSuffix).c_str());
        if(!hqqHiggs140) hqqHiggs140 = (TH1F*)hEmpty->Clone((hName+"qqELI140"+hNameSuffix).c_str());

        if(!hZHiggs110) hZHiggs110 = (TH1F*)hEmpty->Clone((hName+"ZELI110"+hNameSuffix).c_str());
        if(!hZHiggs120) hZHiggs120 = (TH1F*)hEmpty->Clone((hName+"ZELI120"+hNameSuffix).c_str());
        if(!hZHiggs125) hZHiggs125 = (TH1F*)hEmpty->Clone((hName+"ZELI125"+hNameSuffix).c_str());
        if(!hZHiggs130) hZHiggs130 = (TH1F*)hEmpty->Clone((hName+"ZELI130"+hNameSuffix).c_str());
        if(!hZHiggs140) hZHiggs140 = (TH1F*)hEmpty->Clone((hName+"ZELI140"+hNameSuffix).c_str());

        if(!hWplusHiggs110) hWplusHiggs110 = (TH1F*)hEmpty->Clone((hName+"WplusELI110"+hNameSuffix).c_str());
        if(!hWplusHiggs120) hWplusHiggs120 = (TH1F*)hEmpty->Clone((hName+"WplusELI120"+hNameSuffix).c_str());
        if(!hWplusHiggs125) hWplusHiggs125 = (TH1F*)hEmpty->Clone((hName+"WplusELI125"+hNameSuffix).c_str());
        if(!hWplusHiggs130) hWplusHiggs130 = (TH1F*)hEmpty->Clone((hName+"WplusELI130"+hNameSuffix).c_str());
        if(!hWplusHiggs140) hWplusHiggs140 = (TH1F*)hEmpty->Clone((hName+"WplusELI140"+hNameSuffix).c_str());

        if(!hWminusHiggs110) hWminusHiggs110 = (TH1F*)hEmpty->Clone((hName+"WminusELI110"+hNameSuffix).c_str());
        if(!hWminusHiggs120) hWminusHiggs120 = (TH1F*)hEmpty->Clone((hName+"WminusELI120"+hNameSuffix).c_str());
        if(!hWminusHiggs125) hWminusHiggs125 = (TH1F*)hEmpty->Clone((hName+"WminusELI125"+hNameSuffix).c_str());
        if(!hWminusHiggs130) hWminusHiggs130 = (TH1F*)hEmpty->Clone((hName+"WminusELI130"+hNameSuffix).c_str());
        if(!hWminusHiggs140) hWminusHiggs140 = (TH1F*)hEmpty->Clone((hName+"WminusELI140"+hNameSuffix).c_str());
        ...
        if(ELIbarJ) ELIbarJ->SetDirectory(hSoup->GetDirectory());
        if(ELIbarT) ELIbarT->SetDirectory(hSoup->GetDirectory());
        ...
        float lumi = ELIAnalysis::getLumi();
        float weight = 0;
        float scale = 0;
        ...
        hWHiggs110->SetName((hName+"WELI110"+hNameSuffix).c_str());
        TH1F *hWHiggs120 = hWplusHiggs120;
        hWHiggs120->Add(hWminusHiggs120);
        hWHiggs120->SetName((hName+"WELI120"+hNameSuffix).c_str());
        TH1F *hWHiggs125 = hWplusHiggs125;
        hWHiggs125->Add(hWminusHiggs125);
        hWHiggs125->SetName((hName+"WELI125"+hNameSuffix).c_str());
        TH1F *hWHiggs130 = hWplusHiggs130;
        hWHiggs130->Add(hWminusHiggs130);
        hWHiggs130->SetName((hName+"WELI130"+hNameSuffix).c_str());
        TH1F *hWHiggs140 = hWplusHiggs140;
        hWHiggs140->Add(hWminusHiggs140);
        hWHiggs140->SetName((hName+"WELI140"+hNameSuffix).c_str());
	...
	/////////////////////////////////////////////////////
        ...
        ELIbarJ->SetFillColor(kBlue+2);
        ELIbarT->SetFillColor(kBlue+10);
        ...
        outputStream<<"     TTbarJ: "<<ELIbarJ->Integral(0,ELIbarJ->GetNbinsX()+1)<<std::endl;
        outputStream<<"     TTbarT: "<<ELIbarT->Integral(0,ELIbarT->GetNbinsX()+1)<<std::endl;
        ...
        leg->AddEntry(ELIbarJ,"t#bar{t}, j#rightarrow#tau_{h}","f");
        leg->AddEntry(ELIbarT,"t#bar{t}, #tau_{h}","f");
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
std::pair<float,float> ELIHistograms::getQCDControlToSignal(unsigned int iCategory,
                                                            unsigned int iSystEffect){

        ///Return fixed values according to SMH2016 TWiki:
        ///ELIps://twiki.cern.ch/twiki/bin/viewauth/CMS/SMTauTau2016#QCD_background_estimation_in_Lta
        ...
        if(iSystEffect==(unsigned int)ELIAnalysis::QCDSFUp) result.first+=result.second;
        if(iSystEffect==(unsigned int)ELIAnalysis::QCDSFDown) result.first-=result.second;
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F* ELIHistograms::getQCDbackground(unsigned int iCategory,
                                      std::string varName,
                                      unsigned int iSystEffect){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
std::pair<float,float> ELIHistograms::getWNormalisation(unsigned int iCategory, unsigned int iSystEffect){
        ...
        if(iSystEffect==(unsigned int)ELIAnalysis::WSFUp) weight*=(1+WSFUncertainty);
        if(iSystEffect==(unsigned int)ELIAnalysis::WSFDown) weight*=(1-WSFUncertainty);

        outputStream<<"WJets scale with uncertainty: "<<weight<<" WSFUncertainty "<<WSFUncertainty
                    <<" iSystEffect: "<<iSystEffect
                    <<" ELIAnalysis::WSFUp "<<ELIAnalysis::WSFUp
                    <<" ELIAnalysis::WSFDown "<<ELIAnalysis::WSFDown
                    <<endl;
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F *ELIHistograms::get1DHistogram(unsigned int iCategory, std::string varName,
                                    unsigned int iSystEffect){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F *ELIHistograms::getMCSum(unsigned int iCategory, std::string varName,
                              unsigned int iSystEffect,
                              bool sumForW){
        ...
        TH1F *ELIbar = get1D_TT_Histogram((hName+"TTbar"+hNameSuffix));
        TH1F *hST = get1D_ST_Histogram((hName+"ST"+hNameSuffix));
        ...
        else if(ELIbar) hEmpty = (TH1F*)ELIbar->Clone("hEmpty");
        ...
        if(!ELIbar) ELIbar = (TH1F*)hEmpty->Clone((hName+"TTbar"+hNameSuffix).c_str());
        if(!hST) hST = (TH1F*)hEmpty->Clone((hName+"ST"+hNameSuffix).c_str());
